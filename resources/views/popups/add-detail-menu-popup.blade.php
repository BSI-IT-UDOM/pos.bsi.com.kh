...
<div id="popupAddMenuDetail" class="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center hidden">

    <div class="bg-white rounded-lg shadow-lg max-w-xl w-full max-h-screen overflow-y-auto">

        <div class="bg-gradient-to-b from-blue-500 to-blue-400 rounded-t-lg px-6 py-4">

            <h2 class="text-2xl font-bold text-white mb-2">ADD MORE PRICE LIST</h2>

        </div>

        <form action="{{ route('addMenuDetail') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mb-4">
                ...
                <select id="Size_id" name="Size_id" class="text-center border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 @error('IIQ_id') is-invalid @enderror">
                    ...
                    <option value="createSize">++ CREATE NEW ++</option>
            ...
            <div class="text-end">
                ...
                <button type="button" id="closeAddMenuDetailPopup" class="bg-gray-300 hover:bg-gray-400 text-gray-900 px-4 py-2 rounded-md ml-2 focus:outline-none">CANCEL</button>
